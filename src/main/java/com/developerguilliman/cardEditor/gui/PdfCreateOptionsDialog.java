...
public class PdfCreateOptionsDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pageFieldPanel.setLayout(new java.awt.GridLayout(10, 2, 3, 1));
        ...
        pageFieldPanel.add(gridColorLabel);
        ...
        pageFieldPanel.add(cardSizeMMLabel);

        cardSizeMMTextField.setEditable(false);
        pageFieldPanel.add(cardSizeMMTextField);

        cardSizeInchLabel.setText("Card Size inch:");
        pageFieldPanel.add(cardSizeInchLabel);

        cardSizeInchTextField.setEditable(false);
        pageFieldPanel.add(cardSizeInchTextField);
        ...
        fontsFieldPanel.setLayout(new java.awt.GridLayout(7, 4, 3, 1));
        ...
        costValueFontSizeSpinner.setValue(PdfOutput.DEFAULT_COST_VALUE_FONT_SIZE);
        ...
        costValueFontTypeCombo.setSelectedItem(getFontName(PdfOutput.DEFAULT_COST_VALUE_FONT_TYPE));
        ...
        costTypeFontSizeSpinner.setValue(PdfOutput.DEFAULT_COST_TYPE_FONT_SIZE);
        ...
        costTypeFontTypeCombo.setSelectedItem(getFontName(PdfOutput.DEFAULT_COST_TYPE_FONT_TYPE));
        ...
        jPanel4.setLayout(new java.awt.GridLayout(6, 3, 3, 1));
        ...
        jPanel4.add(costBorderCheckBox);

        costBorderColorLabel.setText("Cost Border color");
        jPanel4.add(costBorderColorLabel);
        ...
        jPanel4.add(costBorderColorChooserButton);
        ...
        jPanel4.add(costValueFillCheckBox);

        costValueFillColorLabel.setText("Cost Value color");
        jPanel4.add(costValueFillColorLabel);
        ...
        jPanel4.add(costValueFillColorChooserButton);

        costTypeFillCheckBox.setText("Fill Cost Type");
        jPanel4.add(costTypeFillCheckBox);

        costTypeFillColorLabel.setText("Cost Type color");
        jPanel4.add(costTypeFillColorLabel);
        ...
        jPanel4.add(costTypeFillColorChooserButton);
