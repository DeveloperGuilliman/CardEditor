...
public class PdfCreateOptionsDialog extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4654319975117331077L;
    ...
    private void initComponents() {
        ...
        upperBarCheckBox = new javax.swing.JCheckBox();
        upperBarColorLabel = new javax.swing.JLabel();
        upperBarColorChooserButton = new com.developerguilliman.cardEditor.gui.JColorChooserButton();
        ...
        bw9MenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bw9MenuItemActionPerformed(evt);
            }
        });
        ...
        color8MenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                color8MenuItemActionPerformed(evt);
            }
        });
        resetPopupMenu.add(color8MenuItem);
        ...
        upperBarCheckBox.setText("Upper Bar");
        cardSettingsFieldsPanel.add(upperBarCheckBox);

        upperBarColorLabel.setText("Upper bar color");
        cardSettingsFieldsPanel.add(upperBarColorLabel);

        upperBarColorChooserButton.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        upperBarColorChooserButton.setSelectedColor(new java.awt.Color(255, 255, 255));
        upperBarColorChooserButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                upperBarColorChooserButtonActionPerformed(evt);
            }
        });
        cardSettingsFieldsPanel.add(upperBarColorChooserButton);

        lowerBarCheckBox.setText("Lower Bar");
        cardSettingsFieldsPanel.add(lowerBarCheckBox);

        lowerBarColorLabel.setText("Lower bar color");
        cardSettingsFieldsPanel.add(lowerBarColorLabel);

        lowerBarColorChooserButton.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        lowerBarColorChooserButton.setSelectedColor(new java.awt.Color(255, 255, 255));
        lowerBarColorChooserButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lowerBarColorChooserButtonActionPerformed(evt);
            }
        });
    ...
    private void resetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetButtonActionPerformed
        //builder.reset();
        //setDialogValuesFromBuider();
        resetPopupMenu.show(resetButton, resetButton.getWidth(), resetButton.getY());
    ...
    private void upperBarColorChooserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upperBarColorChooserButtonActionPerformed
        if (upperBarColorChooserButton.openSelectColorDialog(this, "Select upper bar color...") != null) {
            upperBarCheckBox.setSelected(true);
        }
    }//GEN-LAST:event_upperBarColorChooserButtonActionPerformed

    private void lowerBarColorChooserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lowerBarColorChooserButtonActionPerformed
        if (lowerBarColorChooserButton.openSelectColorDialog(this, "Select lower bar color...") != null) {
            lowerBarCheckBox.setSelected(true);
        }
    }//GEN-LAST:event_lowerBarColorChooserButtonActionPerformed

    private void bw9MenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bw9MenuItemActionPerformed
        builder.reset(PdfOutput.DefaultPreset.BW_9);
        setDialogValuesFromBuider();
    }//GEN-LAST:event_bw9MenuItemActionPerformed

    private void bw8MenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bw8MenuItemActionPerformed
        builder.reset(PdfOutput.DefaultPreset.BW_8);
        setDialogValuesFromBuider();
    }//GEN-LAST:event_bw8MenuItemActionPerformed

    private void color8MenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_color8MenuItemActionPerformed
        builder.reset(PdfOutput.DefaultPreset.COLOR_8);
        setDialogValuesFromBuider();
    }//GEN-LAST:event_color8MenuItemActionPerformed
    ...
    private javax.swing.JMenuItem bw8MenuItem;
    private javax.swing.JMenuItem bw9MenuItem;
    ...
    private javax.swing.JMenuItem color8MenuItem;
    ...
    private javax.swing.JCheckBox lowerBarCheckBox;
    private com.developerguilliman.cardEditor.gui.JColorChooserButton lowerBarColorChooserButton;
    private javax.swing.JLabel lowerBarColorLabel;
    ...
    private javax.swing.JPopupMenu resetPopupMenu;
    ...
    private javax.swing.JCheckBox upperBarCheckBox;
    private com.developerguilliman.cardEditor.gui.JColorChooserButton upperBarColorChooserButton;
    private javax.swing.JLabel upperBarColorLabel;
    ...
    private void setDialogValuesFromBuider() {
        ...
        setCheckBoxAndColor(builder.getLowerBarColor(), lowerBarCheckBox, lowerBarColorChooserButton);
        ...
        setCheckBoxAndColor(builder.getUpperBarColor(), upperBarCheckBox, upperBarColorChooserButton);
    ...
    private void setBuilderValuesFromDialog() {
        builder
                ...
                .setUpperBarColor(getColorIfChecked(upperBarCheckBox, upperBarColorChooserButton))
                .setLowerBarColor(getColorIfChecked(lowerBarCheckBox, lowerBarColorChooserButton))
